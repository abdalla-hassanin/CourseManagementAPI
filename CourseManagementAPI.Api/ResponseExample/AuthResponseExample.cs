...
public class RegisterTrainerResponseExample : IExamplesProvider<ApiResponse<bool>>
{
    public ApiResponse<bool> GetExamples()
    {
        return ApiResponse<bool>.Factory.Created(true, "Trainer registered successfully. Please check your email to confirm your account.");
    }
}
